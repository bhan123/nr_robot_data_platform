...
export const mockEpisodes: Episode[] = [
  ...
  {
    episode_id: "EP-20260524-001",
    task_name: "微纳机械触觉抓持精密玻璃管",
    scene: "实验室-日常居家",
    items: ["精密玻璃试管", "试管架"],
    actions: ["触觉反馈抓取", "顺应贴合", "低速微弱插拔"],
    actor: "周杰 (Actor-08)",
    seat_id: "Seat-C2",
    collect_date: "2026-05-24",
    duration: 16.8,
    fps: 30,
    frame_count: 504,
    file_count: 8,
    total_size: "112.5 MB",
    nas_path: "/nas/robot_capture_v2/2026-05-24/EP-20260524-001/",
    qc_status: "pass",
    business_status: "completed",
    pipeline: "ITF",
    collect_mode: "真实手套",
    ...
    tags: ["力觉贴合", "压力传感", "精密微操"],
    meta_info: {
      task_description: "利用内置的柔性阵列触觉压力传感器触头，对极易碎的超薄壁试管进行包络夹持，避免微裂发声并平稳拔出试管。",
      steps: ["双指前端缓慢靠拢试管外壁", "依据 1D 触觉压力达到 1.2N 时停止合拢", "稳定施加 1.25N 握持力", "匀速垂直向上抽离 5cm", "横向移至空试管架并垂直插下"],
      device_id: "Unitree-H1-T6",
      ambient_light: "410lux 荧光灯"
    }
  },
  {
    episode_id: "EP-20260524-002",
    task_name: "多维阵列触觉传感器探测软材质水果",
    scene: "家庭场景-厨房中岛",
    items: ["软质番茄", "水果刀"],
    actions: ["阵列触觉扫描", "顺应硬度测定"],
    actor: "王华 (Actor-02)",
    seat_id: "Seat-B1",
    collect_date: "2026-05-24",
    duration: 20.2,
    ...
    file_count: 9,
    total_size: "158.4 MB",
    nas_path: "/nas/robot_capture_v2/2026-05-24/EP-20260524-002/",
    qc_status: "pass",
    business_status: "published",
    pipeline: "ITF",
    collect_mode: "外骨骼双臂",
    collect_device: "Kepler K1",
    skeleton_type: "17点手部骨指",
    has_video: true,
    has_skeleton: true,
    has_depth: true,
    ...
    data_version: "v1.0.5",
    process_version: "v2.0.4-clean",
    tags: ["材质识别", "硬度自适应", "触觉点阵"],
    meta_info: {
      task_description: "使用点阵触觉皮肤感知多孔海绵和番茄硬度，生成自适应手指运动位移补偿，确保接触不发生破损崩溃。",
      steps: ["手掌掌根接近水果边界", "张开手指以0.2m/s速度进行点阵接触", "反馈阵列表面法向压强", "分析软物质形变并收紧手指", "进行自顺应握姿锁闭"],
      device_id: "Keppler-K1-S1",
      ambient_light: "380lux 暖黄光"
    }
  }
];
